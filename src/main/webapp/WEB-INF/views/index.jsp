...
<html lang="pt-br">
  ...
  <body>
    ...
    <footer class="footer">
      <div class="container">
        <p class="text-muted" align="center">© 2011 - Governo do Estado do Ceará - Todos os direitos reservados</p>
      </div>
    </footer>


<!--modal administrador-->
    <div class="modal fade" id="administrador" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
...
<!--modal monitor-->
    <div class="modal fade" id="monitor" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
