      ...
      <div class="container">
          ...
          <div id="navbar" class="navbar-collapse collapse">
            <form class="navbar-form navbar-right">
             <button type="submit" class="btn btn-warning"> <a href="logoutAdministrador" class="link">Encerrar a sessão</a></button>
            </form>
          </div><!--/.navbar-collapse -->
      </div>
    </nav>
                    ...
                    <div class="col-lg-12" id="centro">
        		                    ...
        		                    <a href="listaLivros" class="item" >
                                      ...
                                      <div id="centraliza" class="centraliza">
                                        <center>
        		                          ...
        		                          <div class="titulo">
        		                              <div class="borda">
        		                                <center> <span>Cadastrar Livros</span></center>
        		                              </div>
        		                          </div>
        		                    </a>
        		              </div>
        		                    ...
        		                    <a href="" class="item">
                                      <div id="centraliza" class="centraliza">
                                        <center>
        		                          ...
        		                          <div class="titulo">
        		                              <div class="borda">
        		                                <center> <span>Cadastrar Professores</span></center>
        		                              </div>
        		                          </div>
        		                    </a>
        		              </div>
                          ...
                          <div class="col-lg-3" id="centro">
                                ...
                                <div id="centraliza" class="centraliza">
                                      ...
                                      <div class="titulo">
                                          <div class="borda">
                                            <center> <span>Cadastrar Alunos</span></center>
                                          </div>
                                      </div>
                                </a>
                          </div>
                          ...
                          <div class="col-lg-3" id="centro">
                                ...
                                <div id="centraliza" class="centraliza">
                                      ...
                                      <div class="titulo">
                                          <div class="borda">
                                            <center> <span>Empréstimos e Devoluções</span></center>
                                          </div>
                                      </div>
                                </a>
                          </div>
                         ...
                         <div class="col-lg-12" id="centro">
                          <div class="col-lg-4" id="centro">
                                ...
                                <div id="centraliza" class="centraliza">
                                      ...
                                      <div class="titulo">
                                          <div class="borda">
                                            <center> <span>Cadastrar Turmas</span></center>
                                          </div>
                                      </div>
                                </a>
                          </div>
                          ...
                          <div class="col-lg-4" id="centro">
                                ...
                                <div id="centraliza" class="centraliza">
                                      ...
                                      <div class="titulo">
                                          <div class="borda">
                                            <center> <span>Cadastrar Monitores</span></center>
                                          </div>
                                      </div>
                                </a>
                          </div>
                          ...
                          <div class="col-lg-4" id="centro">
                                ...
                                <div id="centraliza" class="centraliza">
                                      ...
                                      <div class="titulo">
                                          <div class="borda">
                                            <center> <span>Aréa do Administrador</span></center>
                                          </div>
                                      </div>
                                </a>
                          </div>
